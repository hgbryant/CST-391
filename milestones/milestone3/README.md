...
- This is the Screencast for Milestone 3 ...
- [Milestone 3 Recording](https://www.loom.com/share/fbea3bdd93954394862aff0dd30bb211)

## Conclusion

-  Explain what you learned on this assignment throughly...
     - I gained more experience using Markdown and Mermaid to create diagrams and organize information in a clear and readable way. Learning how to format diagrams and tables correctly helped me present the technical details of the project more effectively.
- Challenges encountered during the project
     - I struggled getting some of the formatting right for the sitemaps and wire frames but it was nothing too difficult. 
- Pending bugs or issues remaining in the solution
     - As of right now I do not think I have any bugs remaining in my solution
- Lessons learned that could be leveraged in future web application projects
     - Planning ahead and really understanding the flow of a project before starting on the code.
